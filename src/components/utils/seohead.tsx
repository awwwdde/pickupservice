...
const SEO_BY_ROUTE: Record<string, SeoConfig> = {
  '/': {
    title: 'ПикапСервис-МСК',
    description:
      'Автосервис для пикапов и внедорожников в Москве: ремонт Toyota Hilux, Land Cruiser, Prado, Nissan Patrol и Navara, Mitsubishi Pajero, Ford Ranger; тюнинг 4x4, ТО, диагностика, экспедиционная подготовка, трофи, лебёдки, силовые бамперы, шноркели, подвеска. 4x4 experience на русском и английском.'
  },
  '/portfolio': {
    title: 'Портфолио ПикапСервис-МСК — проекты по подготовке внедорожников и пикапов',
    description:
...
export default function SeoHead() {
  ...
  useEffect(() => {
    ...
    const config =
      ...
      (isPortfolioDetailsRoute
        ? {
            title: 'Проект ПикапСервис-МСК — кейс по ремонту и тюнингу внедорожника',
            description:
