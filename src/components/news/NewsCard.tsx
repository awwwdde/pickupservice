      ...
      <AnimatePresence>
        {isVisible && news && (
          <motion.div
            ...
            className="glass-header pointer-events-auto absolute z-[100] overflow-hidden border border-white/10 shadow-2xl right-3 bottom-28 w-[min(248px,76vw)] p-2.5 sm:right-4 sm:bottom-32 sm:w-[min(280px,68vw)] md:bottom-[clamp(10.5rem,20vh,13rem)] md:right-6 md:w-[min(300px,34vw)] md:p-3 lg:right-[min(35px,6vw)] lg:w-[min(360px,28vw)] lg:p-4 min-[1440px]:lg:w-[440px]"
          >
            <button
