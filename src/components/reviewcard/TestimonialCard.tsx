...
export const TestimonialCard: FC<TestimonialCardProps> = ({ quote, name, car }) => {
  return (
    ...
    ">
      <span className="mb-4 text-4xl font-serif text-[#FF8201] md:text-6xl">&ldquo;</span>
      
      <p className="font-serif italic text-lg sm:text-xl md:text-3xl lg:text-4xl text-white leading-tight">
        {quote}
      </p>
